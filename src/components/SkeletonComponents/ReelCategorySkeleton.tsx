...
const ReelCategorySkeleton = ({ items }: { items?: number }) => {
  return (
    <>
      {Array(items || 4)
        .fill("")
        .map((index: number) => (
          <div className="border animate-pulse" key={"reel_skeleton" + index}>
            <div className="flex items-center justify-center aspect-[9/12] bg-gray-300">
              <svg
...
export default ReelCategorySkeleton;
